  ...
  return (
    <div id="NCTips">
      ...
      <details>
        ...
        <p>
          Click on a node or edge. Find the "Provenance" tab on the left-hand side of
          the screen. What do you notice?
        </p>
        <ul>
      ...
      <details>
        <summary>Look for large and small nodes</summary>
        <ul>
          <li>Which nodes are the largest?</li>
          <li>Which are the smallest?</li>
        </ul>
        <p>
          Click on the large nodes and small nodes to see what makes them different.
        </p>
      </details>
      <details>
        <summary>Try moving nodes around</summary>
        <p>
          Click on a node and drag it around. (This can help make the importance of
          different connections visible.)
        </p>
        <details>
          <summary>Does a lot move? </summary>
          <p>
            This node might have a lot of influence on other nodes in this network
          </p>
        </details>
        <details>
          <summary>Does not much move?</summary>
          <p>
            Maybe there are other big nodes with a lot of influence "anchoring" the
            other nodes in the network in place against the influence of the node
            you're dragging.
          </p>
        </details>
      </details>
      <details>
        <summary>Look at detailed data for the nodes/edges</summary>
        Click on the Nodes or Edges tab at the top. These two tabs show all of the
        details for each node or edge in the network
        <ul>
          ...
          <li>
            ...
            button to open the node/edge detail panel on the left. Find the
            "Provenance" tab and click it. Sort by the fields listed here. What do you
            notice?
          </li>
        </ul>
      </details>
      <details>
        <summary>Limit what shows in the visualization</summary>
        Try using the "Analysis" tab. Choose only one node or edge type to display,
        and then see what that changes about the network view.
      </details>
    </div>
  );
}
