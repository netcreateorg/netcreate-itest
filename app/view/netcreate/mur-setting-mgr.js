...
/// INITIALIZE MODULE /////////////////////////////////////////////////////////
/// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
/** Legacy Node Type Schema for json-editor */
...
/// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
/** Legacy Edge Type Schema for json-editor */
...
/// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
/** Legacy Template Schema for json-editor
 *  References NODETYPEOPTIONS and EDGETYPEOPTIONS above */
const TEMPLATE = {
...
/// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
/** Legacy API: Extra schema definition for the Type Editor UI
...
function GetTypeEditorSchema(schemaTypeOptions) {
...
/// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
/** Legacy API: ParseTemplateSchema generates and resturns the default template
 *  json Use this to create a pristine defaul template json */
